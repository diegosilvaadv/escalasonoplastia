  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final meuPerfilUsersRecord = snapshot.data!;
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Expanded(
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              stream: UsersRecord.getDocument(listViewEscalaRecord.userRef!),
                                                                              builder: (context, snapshot) {
                                                                                // Customize what your widget looks like when it's loading.
                                                                                if (!snapshot.hasData) {
                                                                                  return Center(
                                                                        ...
                                                                        if (listViewEscalaRecord.userRef ==
